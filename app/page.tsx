...
export default function Page() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-pink-50 via-white to-red-50 flex items-center justify-center p-4 sm:p-6 lg:p-8 overflow-hidden">
        ...
        <div className="bg-white/95 backdrop-blur-md rounded-3xl shadow-2xl p-6 sm:p-10 lg:p-12 border border-pink-100">
          ...
          <div className="text-center mb-6">
            <div className="flex items-center justify-center gap-2 mb-2">
              ...
              <h1 className="text-3xl sm:text-4xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-pink-600 to-red-600 tracking-tight">
                Welcome!
              </h1>
            ...
            <div ref={dropdownRef} className="relative w-full max-w-md mx-auto">
              ...
              >
                ...
                <div className="flex items-center gap-3 relative z-10">
                  <div className="w-9 h-9 rounded-full bg-gradient-to-br from-pink-500 via-pink-600 to-red-600 flex items-center justify-center text-white shadow-md group-hover:shadow-lg transition-all duration-300 group-hover:scale-110 group-hover:rotate-12">
